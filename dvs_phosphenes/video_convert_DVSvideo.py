...
# out_filename = "events.aedat" #@param {type:"string"}
# # Output DVS events as aedat event database.
...
# v2e_command += ["--output_width=346", "--output_height=260"]
...
print(input_terminal)

# os.system('~/miniconda3/envs/dvs/bin/python ~/PycharmProjects/v2e/v2e.py -i /home/duinch/PycharmProjects/RL-mobility/Python/Experiments/CHANTAL/v2e_tutorial_video.avi -o /home/duinch/PycharmProjects/RL-mobility/Python/Experiments/CHANTAL/v2e-test-output --overwrite --unique_output_folder false --davis_output --dvs_h5 events.h5 --dvs_aedat2 None --dvs_text None --no_preview --dvs_exposure duration .033 --input_frame_rate 30 --input_slowmotion_factor 1 --disable_slomo --auto_timestamp_resolution false --pos_thres 0.2 --neg_thres 0.2 --sigma_thres 0.03 --cutoff_hz 30 --leak_rate_hz 0.1 --shot_noise_rate_hz 5')
